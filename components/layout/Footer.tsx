    ...
    <footer className="footer-section relative bg-[#0B1220] text-white rounded-t-[28px] sm:rounded-t-[52px] pt-12 sm:pt-16 pb-12 sm:pb-16 -mt-2">
      <div className="w-layout-blockcontainer container w-container relative z-10">
        <div className="footer-contents-wrapper">
          ...
          {/* Link columns */}
          <div className="footer-links-wrapper flex flex-wrap justify-between gap-10 sm:gap-12 mt-12 sm:mt-14">
            {LINK_COLS.map((col, i) => (
              <div key={i} className="footer-links-block flex flex-col items-start gap-3 sm:gap-4 min-w-[140px]">
                {col.map((link) => (
                  <Link
                    key={link.label}
                    href={link.href}
          ...
          <div className="footer-bottom-contents-wrapper flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12 lg:gap-20 mt-14 sm:mt-16 lg:mt-20">
            <Link href="/" className="brand-block inline-flex items-center justify-start p-0.5 -ml-1">
              <BrandLogo variant="footer" />
            </Link>

            <div className="footer-info-contents-block w-full max-w-md">
              ...
              <div className="footer-lower-text-block mt-10 sm:mt-14">
